...
print('setting:%d\n' % setting)
path_domain = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/domain_basic.pddl'
if setting == 0:
    path_problem = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/problem_basic.pddl'
else:
    path_problem = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/problem_basic_2.pddl'
# test
# path_problem = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/problem_basic.pddl'
# path_problem = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/problem_basic_2.pddl'
try:
