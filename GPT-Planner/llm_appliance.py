...
def plan_modifier_add_effect_appliance(task_id, situation_predicate, situation_object, selected_appliance, path_domain, path_problem):
    ...
    domain_new_path = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/domain_new2.pddl'
    ...
    problem_new_path = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/problem_new2.pddl'
