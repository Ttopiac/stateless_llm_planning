...
<img src="https://github.com/yding25/llm_world/GPT-Planner/blob/master/dataset/situation.png" width="57%" height="45%">

<img src="https://github.com/yding25/llm_world/GPT-Planner/blob/master/dataset/solution.png" width="42%" height="24%">

## Experiment Results
All experiment results (log files) can be found in the folder "/llm_world/GPT-Planner/results". For example, the below figure shows situation0 in task4 has been handled in some trials, and some are not.

<img src="https://github.com/yding25/llm_world/GPT-Planner/blob/master/dataset/result.png" width="42%" height="24%">
