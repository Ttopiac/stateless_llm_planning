...
def task_planner(path_domain, path_problem, name_output):
    path_engine = '/home/' + getpass.getuser() + '/llm_world/GPT-Planner/FastDownward/fast-downward.py'
    if os.path.exists(path_engine):
        ...
        return '/home/' + user + '/llm_world/GPT-Planner/' + name_output
    else:
...
def exist_remove(task_id):
    ...
    path2 = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/domain_new.pddl'
    path3 = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/domain_new1.pddl'
    path4 = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/domain_new2.pddl'
    path5 = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/problem_new.pddl'
    path6 = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/problem_new1.pddl'
    path7 = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/problem_new2.pddl'
    path8 = '/home/' + user + '/llm_world/GPT-Planner/task_' + str(task_id) + '_basic_plan.txt'
    path9 = '/home/' + user + '/llm_world/GPT-Planner/task_' + str(task_id) + '_modified_plan_1.txt'
    path10 = '/home/' + user + '/llm_world/GPT-Planner/task_' + str(task_id) + '_modified_plan_2.txt'
    path11 = '/home/' + user + '/llm_world/GPT-Planner/task_' + str(task_id) + '_modified_plan_3.txt'
