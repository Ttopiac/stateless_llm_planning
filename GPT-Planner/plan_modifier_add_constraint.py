...
def plan_modifier_add_constraint(task_id, situation_action, situation_predicate, situation_object, situation_object_new, path_domain, path_problem):
    ...
    new_path_domain = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/domain_new.pddl'
    ...
    new_path_problem = '/home/' + user + '/llm_world/GPT-Planner/pddl/task' + str(task_id) + '/problem_new.pddl'
